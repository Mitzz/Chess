...
public class Program {
	...
	private static void checkmateCasesTest() {
		Game game = new Game();
		move(game, 2, 'd', 3, 'd');
		render(game);
		move(game, 7, 'd', 6, 'd');
		...
		//====================
//		move(game, 'e', 7, 'e', 5);//Piece Movement Blocked due to check
//		render(game);
//		move(game, 'a', 6, 'b', 4);//Piece Movement Blocked due to check
//		render(game);
		move(game, 'a', 6, 'c', 7);
		render(game);
		move(game, 'c', 1, 'a', 3);
...
//		render(game);
	...
	private static void kingMovementDueToCheckTest() {
		Game game = new Game();
		move(game, 2, 'd', 3, 'd');
		render(game);
		move(game, 7, 'd', 6, 'd');
		...
		move(game, 'h', 4, 'f', 3);
		render(game);
//		move(game, 'f', 4, 'h', 3);//King Movement necessary due to check
//		render(game);
		move(game, 'e', 1, 'e', 2);
		render(game);
		move(game, 'f', 3, 'd', 4);
...
//		render(game);
		...
		move(game, 'f', 1, 'b', 5);
		render(game);
		move(game, 'c', 6, 'b', 8);//Should be handle - Case I - Should not be allowed
		render(game);
		move(game, 'd', 1, 'd', 2);
		render(game);
//		move(game, 'b', 8, 'c', 6);//Should be handle - Case II -  Should be allowed
//		render(game);
	}
